...
eigenvec_real=X(dim+2+(1:dim)); 
eigenvec_imag=X(2*dim+2+(1:dim)); % The real and imaginary parts of the eigenvector
...
% to avoid including 0 in the interval, we take the worst case scenario
Z2 = intval(sup(Z2));
